...
| **Project governance** (plan · Kanban · RACI · Gantt) | [`Project Governance/v3/`](Project%20Governance/v3/) — v3 is current |
...
| [`Project Governance/`](Project%20Governance/) | Project plan, Kanban, RACI, Gantt (**v3** = current; earlier versions superseded). |
