...
export function Stepper({ step }: { step: number }) {
  return (
    <>
      ...
      <aside
        className="seller-stepper-vertical"
        style={{
          width: 220,
          flexShrink: 0,
          padding: '48px 24px',
      ...
      <div
        className="seller-stepper-horizontal"
        style={{
          padding: '16px 24px',
      ...
      <style>{`
        @media (min-width: 1024px) {
          .seller-stepper-vertical { display: block !important; }
          .seller-stepper-horizontal { display: none !important; }
        }
      `}</style>
    </>
  );
