...
\date{August 2026 \\ BEEM063 FinTech Hackathon \\ University of Exeter}
...
final section works through the choice between the three principal Emirati jurisdictions
available to a fintech entrant. This document is a working compliance reference prepared
...
than in a wallet Blockmediary itself controls, the product avoids characterising itself as
a custodian in the ordinary sense. For production use, the safer path is to partner with an
authorised cryptoasset custodian for any component of the flow that does resemble
safeguarding. For the hackathon build, the product operates on testnet with mock USDC,
so no regulated custody activity is actually triggered, but the Policy Statement expected in
the summer of 2026 should be monitored and the architecture reassessed once the final rules
are published.
...
architecture depends on several third party technology providers, including Anthropic for
artificial intelligence based document analysis, cloud infrastructure for document storage
and the audit ledger, a know your business and know your customer provider, and a
blockchain node provider for mainnet access, each of which counts as a third party
...
\subsection*{4.1 The Mainland Regime}
...
entirely at this stage by structuring market entry through the Abu Dhabi Global Market or
the Dubai International Financial Centre, both of which offer more accessible crypto
licensing frameworks, discussed further in section eight.

\subsection*{4.2 Dubai and the Virtual Assets Regulatory Authority}

Outside the two financial free zones, virtual asset activity in Dubai is regulated by the
Virtual Assets Regulatory Authority, whose Rulebook version 2.0 took effect in June 2025
\citep{vararulebook2025}. Category 1 tokens, which include stablecoins, now require prior
approval from the Authority before issuance or distribution, so distributing or
facilitating USDC in Dubai without using an approved stablecoin and a licensed distributor
could breach the Rulebook, and operating a virtual asset escrow or transfer service in
Dubai without the relevant Authority licence, whether for virtual asset management and
investment, broker dealing, or custody, triggers penalties. Blockmediary's mitigation for
any future production launch specifically targeting Dubai outside the free zones is to
use only Authority approved stablecoins and licensed distributors, and to obtain the
appropriate Authority licence before facilitating transactions there.

\subsection*{4.3 The Free Zone Alternative}

Two free zone frameworks present a materially lower risk path than either the mainland or
Dubai's Virtual Assets Regulatory Authority regime. The Financial Services Regulatory
Authority's Digital Asset Framework within the Abu Dhabi Global Market is well regarded
internationally and has already granted licences to firms providing crypto custody,
exchange, and brokerage services, while the Dubai Financial Services Authority's crypto
token regime within the Dubai International Financial Centre, first issued in 2022 and
updated since, offers a comparable regulated pathway \citep{difcdfsa2022}. Either free
zone could serve as Blockmediary's regulatory home for the minimum viable product and
early production stage, and the Financial Services Regulatory Authority's Innovation
Programme, known as RegLab, offers a structured pathway that may suit a hackathon to pilot
trajectory particularly well. Section eight below works through the choice between these
two free zones, and the mainland alternative, in detail.
...
under this law. The Dubai International Financial Centre and the Abu Dhabi Global Market
each maintain their own data protection frameworks, the Dubai International Financial
Centre's Data Protection Law of 2020 and the Abu Dhabi Global Market's Data Protection
Regulations of 2021, both of which are arguably more mature than the federal law
\citep{difcdplaw2020, adgmdpr2021}. Blockmediary's mitigation is to align with the federal
law's core principles now, to comply with the relevant free zone framework for any entity
established in the Dubai International Financial Centre or the Abu Dhabi Global Market,
and to monitor the federal executive regulations once published so that any additional
requirements can be implemented within the grace period.
...
review workflow, to use artificial intelligence assisted document extraction to flag price
and quantity inconsistencies automatically, to require mandatory human review before any
release involving a first time counterparty pairing, and to train document reviewers on
the Financial Action Task Force's published typologies for this form of laundering.
...
Token Services Regulation \citep{cbuaeptsr2024}, Federal Decree Law No. 6 of 2025 extending
oversight to decentralised finance and Web3 infrastructure \citep{uaefdl62025}, the Virtual
Assets Regulatory Authority's Rulebook version 2.0 \citep{vararulebook2025}, the federal
Personal Data Protection Law \citep{pdpl2021}, the Dubai International Financial Centre's
Data Protection Law \citep{difcdplaw2020}, the Abu Dhabi Global Market's Data Protection
Regulations \citep{adgmdpr2021}, the Dubai Financial Services Authority's crypto token
regime \citep{difcdfsa2022}, and the Financial Services Regulatory Authority's guidance on
tokenised securities and decentralised finance \citep{adgmfsra2026}.
...
%---------------------------------------------------------------
\section*{8. United Arab Emirates Jurisdiction Choice}
%---------------------------------------------------------------

Three Emirati jurisdictions are available to Blockmediary as it considers a United Arab
Emirates market entry, and each serves a different purpose. The Jebel Ali Free Zone
Authority, commonly known as JAFZA, is a tier one logistics and trading free zone, well
suited to import and export activity, warehousing, and physical goods businesses, but it
is not a financial services regulator: regulated activities such as crypto escrow,
payment services, and custody fall instead under the Virtual Assets Regulatory Authority
in Dubai or the federal Central Bank on the mainland. JAFZA could house a holding company
or a commercial subsidiary for Blockmediary, but it cannot serve as the regulatory home
for the financial services product itself, and is therefore not suitable as Blockmediary's
primary regulatory base, useful only as a commercial or holding entity if one is needed
alongside the regulated entity.

The Dubai International Financial Centre is regulated by the Dubai Financial Services
Authority, modelled closely on the Financial Conduct Authority, and operates under English
common law with independent courts, which is familiar territory for United Kingdom and
European Union trained legal counsel. Its crypto framework, the Investment Token and
Crypto Token regime published in 2022, allows firms to obtain a licence covering custody,
exchange, and arranged services for crypto tokens within the centre \citep{difcdfsa2022}.
The centre hosts an ecosystem of over eight thousand eight hundred registered companies as
of 2025, including major international banks and professional services firms, alongside
the FinTech Hive accelerator, and its capital requirements run around twenty to thirty per
cent higher than the Abu Dhabi Global Market's. Its Innovation Testing Licence allows
testing of innovative financial products for up to two years without full authorisation,
and its Data Protection Law of 2020 is a mature, broadly General Data Protection
Regulation aligned framework. The Dubai International Financial Centre suits Blockmediary
best if the team wants Financial Conduct Authority style regulation, maximum institutional
credibility, and access to the largest financial ecosystem in the Middle East.

The Abu Dhabi Global Market is regulated by the Financial Services Regulatory Authority, a
principles based and comparatively flexible regulator that has been crypto forward since
2018, and likewise operates under English common law. Its virtual asset framework,
published in 2018, was the first formal framework of its kind in the Middle East, with
updated guidance issued in March 2026 covering tokenised securities, decentralised
finance, and artificial intelligence driven systems, and its licence categories include
multilateral trading facility, broker dealer, custodian, and investment manager
authorisations for digital assets \citep{adgmfsra2026}. The market held over twelve
thousand active licences as of 2026, is backed by the Abu Dhabi government, and carries
strong sovereign wealth fund connections. Its capital requirements sit twenty to thirty per
cent below the Dubai International Financial Centre's, a meaningful difference for a
startup, its Digital Lab sandbox offers active engagement with founders and a rapid
testing pathway, and its Data Protection Regulations of 2021 are similarly General Data
Protection Regulation aligned. The Abu Dhabi Global Market suits Blockmediary best if the
team wants lower capital requirements, a more founder friendly regulator, and the most
advanced crypto specific licensing framework currently available in the United Arab
Emirates.

Weighing these three options against the criteria that matter most at this stage, namely
crypto and fintech licensing availability, the presence of English common law, capital
requirements, regulator flexibility, ecosystem prestige, the availability of a sandbox or
innovation pathway, and alignment with the General Data Protection Regulation, the Abu
Dhabi Global Market wins on licensing availability, capital requirements, regulator
flexibility, and sandbox availability, the Dubai International Financial Centre wins on
ecosystem prestige for later stage institutional conversations, and the two are tied on
common law availability and data protection alignment, while JAFZA does not compete on
financial licensing at all. The recommended path is to incorporate in the Abu Dhabi Global
Market and apply for the Financial Services Regulatory Authority's Digital Lab or
Innovation Testing Licence for the minimum viable product phase, using the Abu Dhabi
Global Market as the regulatory home for Gulf Cooperation Council and wider Middle East and
North Africa market launch, before considering a second entity in the Dubai International
Financial Centre once institutional partnerships with banks or trade finance houses are
being actively pursued, since that ecosystem is better suited to those specific
conversations. JAFZA would only be relevant if the team separately wanted a holding or
trading entity for physical goods logistics, which is not the fintech product itself. On
data protection specifically, both free zones maintain their own frameworks that are
separate from, and more developed than, the federal Personal Data Protection Law, and both
are closely aligned with the General Data Protection Regulation's principles of lawful
basis, data minimisation, data subject rights, and breach notification, so compliance with
the General Data Protection Regulation will largely, though not entirely, satisfy either
free zone's requirements; European Union residents' data remains subject to the General
Data Protection Regulation directly regardless of where Blockmediary itself is
incorporated, so incorporation in either free zone does not exempt the product from that
separate obligation.
